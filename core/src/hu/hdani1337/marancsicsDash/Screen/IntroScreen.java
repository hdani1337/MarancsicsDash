...
public class IntroScreen extends MyScreen {
   IntroStage introStage;
    ...
    public IntroScreen(marancsicsGame game) {
        ...
        else if (keparany >= (18.67/9.0f)) introStage = new IntroStage(new FitViewport(1493,720),spriteBatch,game);
        else if (keparany >= (18.5f/9.0f)) introStage = new IntroStage(new FitViewport(1480,720),spriteBatch,game);
