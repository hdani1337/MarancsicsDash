package hu.hdani1337.marancsicsDash.MyBaseClasses.Game;
...
*/
    ...
    public void setScreenBackByStackPop(){
        if (backButtonStack.size()>1){
            try {
                setScreen((MyScreen) backButtonStack.pop().getConstructor(marancsicsGame.class).newInstance(this),false);
